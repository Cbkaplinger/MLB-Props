...
Examples:
    python production/projections/grade_projections.py
    python production/projections/grade_projections.py --date 2026-07-27
    ...
    *,
    ...
    if not LOG_PATH.exists():
        raise FileNotFoundError(
            f"No projection log at {LOG_PATH}. Run production/projections/log_projections.py first."
        )
