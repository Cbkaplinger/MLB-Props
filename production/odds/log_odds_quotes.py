...
Examples:
    python production/odds/log_odds_quotes.py --book novig --date 2026-07-30 ^
      --quote "Sean Burke,6.5,-150,+130" --quote "Andre Pallante,4.5,+163,-185"

    python production/odds/log_odds_quotes.py --book novig --unit 50 --list-board
"""
...
def _load_board(slate: date | None, preferred_only: bool) -> pl.DataFrame:
    if not LOG_PATH.exists():
        raise SystemExit(f"Missing {LOG_PATH}. Run production/projections/log_projections.py first.")
