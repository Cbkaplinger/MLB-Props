...
`Odds-Open-Close-2025-2026/` stores historical market snapshots pulled outside
the live ledger loop (for example `pitcher_strikeouts_early_open_2025_2026.csv`
and `pitcher_outs_open_2025_2026.csv`). Treat these as source datasets for
backtests and opening-line calibration research; do not overwrite them from
