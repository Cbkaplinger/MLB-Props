...
- TBF set `workload_context_bullpen` **frozen**
  (`docs/tbf_first_model_findings.md`)
- Count layer v1 chrono-scored (`docs/count_layer_findings.md`)
- See `docs/workload_rest_bullpen_feature_plan.md`

## First model

Fitted: `docs/tbf_first_model_findings.md` (`Models/TBF-Model/train.py`).
