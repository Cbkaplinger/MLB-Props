...
**Date:** 2026-07-27  
**Runners:**
- `Models/Strikeout-Model/Strikeout-EDA/leave_family_out_ablation.py --feature-set production --models lightgbm`
- `Models/Strikeout-Model/Strikeout-EDA/step8_keep_drop.py`  
...
python Models/Strikeout-Model/Strikeout-EDA/leave_family_out_ablation.py --feature-set production --models lightgbm
```
...
(`docs/step10_p1_registry_freeze.md`). Further family drops remain closed.
