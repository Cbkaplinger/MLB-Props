...
(`docs/phase_d_population_findings.md`) — pregame role labels still open  
**Date:** 2026-07-27  
**Priority:** after Step 7 freeze; primary home is projected TBF, not k-rate.  
**Phase A/B write-up:** `docs/tbf_spine_phase_ab.md`  
**First TBF fit:** `docs/tbf_first_model_findings.md`
...
**Interim policy frozen** — full write-up: `docs/phase_d_population_findings.md`.
...
2. **Opener / piggyback** — interim policy: keep `PA ≥ 9` research estimand;
   ...
   until pregame role exists (`docs/phase_d_population_findings.md`).
