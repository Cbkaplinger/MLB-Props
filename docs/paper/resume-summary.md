...
**Paper money track (deduped 38 days, `n=324`):** PnL `+$619` (+3.0% ROI), mean CLV `+0.70`pp on `n_clv=195`; veto lane +7.0% (`n=264`) — paper prices, not fills. ≥50 real fills remain the money-truth gate.
