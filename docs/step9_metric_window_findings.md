...
**Runners:**
- `Models/Strikeout-Model/Strikeout-EDA/step9_metric_window_select.py`
- `Models/Strikeout-Model/Strikeout-EDA/step9_widen_priority.py`
- `Models/Strikeout-Model/Strikeout-EDA/step9c_short_std_and_p1.py`
- `Models/Strikeout-Model/Strikeout-EDA/print_step9_inventory.py`  
...
```powershell
# Rates + static (done)
python Models/Strikeout-Model/Strikeout-EDA/step9_metric_window_select.py --skip-means

# Mean/physics (in progress / rerun)
python Models/Strikeout-Model/Strikeout-EDA/step9_metric_window_select.py --means-only

# Re-assemble + bake-off only
python Models/Strikeout-Model/Strikeout-EDA/step9_metric_window_select.py --finalize-only
```
...
features) — see `docs/step10_p1_registry_freeze.md` and
