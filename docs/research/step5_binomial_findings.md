...
**Runner:** `models/Strikeout-Model/research/binomial_nested_compare.py`  
...
1. PA-weighting ≈ no gain (see `docs/research/step5_pa_weight_findings.md`)
...
- Remaining critical path: Phase 11 model quality (tune / walk-forward /
  ...
  (`docs/research/phase11_model_quality_gates.md`, `docs/diagrams/04-roadmap.md`).
