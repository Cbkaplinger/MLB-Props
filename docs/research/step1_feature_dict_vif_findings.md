...
|---|---:|---|
| **LightGBM `production`** | **180** | **Current freeze (Step 10).** Step 7 mean-window thin (185) + Step 9c/10 P1 physics swap. See `docs/research/step10_p1_registry_freeze.md`. |
...
and in `docs/research/step10_p1_registry_freeze.md` (current production is **180**).
