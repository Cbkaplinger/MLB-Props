...
**Runners:**
- `models/Strikeout-Model/research/targeted_window_ablation.py`
- `models/Strikeout-Model/research/physics_window_ablation.py`
...
- Step 7 **drops mean-family P10 from the LightGBM feature set** without
  rebuilding parquet (`docs/research/step7_registry_freeze.md`).
