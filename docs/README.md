...
| `statistical_audit_and_sequencing_report.md` | Formal audit / sequencing |
| `CLEANUP_LOG.md` | Repository cleanup history |
| `phase11_model_quality_gates.md` | Tune / walk-forward / calibration gates |
...
under `../artifacts/` (gitignored); see `../artifacts/README.md` for lifecycle.
