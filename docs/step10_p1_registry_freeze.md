...
**Status:** frozen  
**Date:** 2026-07-28  
**Evidence:** `docs/step9_metric_window_findings.md` (Step 9c)  
...
Canonical plan: `docs/phase11_model_quality_gates.md`. Live inference follows
those gates (`docs/live_assembly_plan.md`).
