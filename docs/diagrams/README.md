...
Canonical prose lives in `docs/reference/model-card.md`, `docs/reference/dev-notes.md`, and
`docs/research/statistical_audit_and_sequencing_report.md`. When a diagram and those
