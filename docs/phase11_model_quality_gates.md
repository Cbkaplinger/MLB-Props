...
frozen — see `docs/phase_d_population_findings.md`  
**Date:** 2026-07-28  
...
| Component | Lock |
|---|---|
| K-rate features | `production` 180 (`docs/step10_p1_registry_freeze.md`) |
...
**Done (audit + policy):** `docs/phase_d_population_findings.md`.
...
- [x] `Models/Strikeout-Model/Strikeout-EDA/tune_lightgbm_production.py` (nested HPO)
- [x] TBF `alpha` grid + **joblib persist** in `Models/TBF-Model/train.py`
- [x] `Models/Strikeout-Model/Strikeout-EDA/walkforward_stack_backtest.py`
- [x] `Models/Strikeout-Model/Strikeout-EDA/calibrate_stack.py`
...
```powershell
python Models/Strikeout-Model/Strikeout-EDA/tune_lightgbm_production.py --refit
python Models/TBF-Model/train.py --model ridge --tune-alpha --persist
python Models/Strikeout-Model/Strikeout-EDA/walkforward_stack_backtest.py
python Models/Strikeout-Model/Strikeout-EDA/calibrate_stack.py
python Models/Strikeout-Model/Strikeout-EDA/phase_d_population_audit.py
```

See `diagrams/04-roadmap.md` and `diagrams/03-modeling-and-evaluation.md`.
